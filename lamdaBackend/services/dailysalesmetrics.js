...
// updateing inventory
    ...
    const DailySalesMetricsUser = await getDailySalesMetricsUser(date);

    if (DailySalesMetricsUser) {
      DailySalesMetricsUser.SalesPlanList.push(...data.SalesPlanList);
      const params = {
        ...
        ExpressionAttributeValues: {
          ":SalesPlanList": DailySalesMetricsUser.SalesPlanList,
        },
    ...
    const body = {
      operation: "added DailySales Metrics To Database",
      message: "SUCCESS",
      status: 200,
      item: data,
    };
...
async function getDailySalesMetricsUser(e) {
    const params = {
      TableName: DailySalesMetricsTable,
      Key: {
        Date: e,
