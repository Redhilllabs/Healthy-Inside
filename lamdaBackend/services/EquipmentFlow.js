...
const EquipmentFlowTable = "EquipmentFlow";


 async function getEquipmentFlow() {
    const params = {
      TableName: EquipmentFlowTable,
    };
...
const AddToEquipmentFlow = async(requestBody) => {
...
module.exports =  {AddToEquipmentFlow,getEquipmentFlow};