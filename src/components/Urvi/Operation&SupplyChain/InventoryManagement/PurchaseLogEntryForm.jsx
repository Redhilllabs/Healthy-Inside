  ...
  const handlesave = async () => {
    try {
      ...
      if (response.status === 401) {
        throw new Error("Data not saved in PurchaseLogEntry");
      }
      ...
      if (response2.status === 401) {
        throw new Error("Data not saved in Inventory");
      }
          ...
          <div className="option_container">
            ...
            >
              ...
              <option value="Kashmiri Red Chilli Powder (कश्मीरी लाल मिर्च पाउडर/Kasmiri Lal Mirch Powder)">
                Kashmiri Red Chilli Powder ,(कश्मीरी लाल मिर्च पाउडर/Kasmiri Lal
                Mirch Powder)
              </option>
              ...
              <option value="Sambhar Masala Powder (सांभर मसाला पाउडर/Sambhar Masala Powder)">
                Sambhar Masala Powder (सांभर मसाला पाउडर/Sambhar Masala Powder)
              </option>
